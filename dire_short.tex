...
default DiRe configuration is the fixed comparator.
...
\begin{figure}[tbp]
    ...
    the favourable direction. Lower stress, smaller absolute context-score
    magnitude, and lower Betti--curve discrepancy are better, whereas higher
    neighborhood overlap is better. The printed context means retain the
    signed score defined in the Methods; their absolute magnitudes determine
    the colour and effect. The continuous colour scale is centred at equality
    and clipped at $\pm1$ for legibility; the printed effect values are not
    clipped.}
...
\begin{figure}[tbp]
    ...
    separate panels. The GPU panel compares default DiRe--RAPIDS,
    cuML tSNE, and cuML UMAP on the same
...
\begin{table}[tbp]
  ...
  row--index subset for the corresponding layout seed. Default DiRe is the
  fixed comparator.}
...
\begin{table}[tbp]
  ...
  \small
  \resizebox{\textwidth}{!}{%
    \input{generated/revision3/revision3-dataset-stats.tex}}
...
recall \TenxDireSpectralAdjacencyCellWeighted{}. UMAP remains the leader in the
...
\begin{table}[tbp]
  \centering
  \resizebox{\textwidth}{!}{%
    \input{generated/revision3/revision3-tenx-adjacency-summary.tex}}
...
\begin{table}[tbp]
  \centering
  \resizebox{\textwidth}{!}{%
    \input{generated/revision3/revision3-backend-policy-audit.tex}}
...
\begin{table}[tbp]
  \centering
  \resizebox{\textwidth}{!}{%
    \input{generated/revision3/revision3-arxiv-topology-paired-effects.tex}}
...
\input{generated/revision3/revision3-tenx-markers.tex}
